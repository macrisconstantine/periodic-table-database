...
--
-- Name: elements u_constraint; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.elements
    ADD CONSTRAINT u_constraint UNIQUE (symbol, name);


--
-- Name: properties fk_properties_id; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.properties
    ADD CONSTRAINT fk_properties_id FOREIGN KEY (atomic_number) REFERENCES public.elements(atomic_number);
